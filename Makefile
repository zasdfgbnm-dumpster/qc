...
COMMON=Makefile src/common.hpp src/aces.hpp src/hartree_fock.hpp src/matrix.hpp src/utils.hpp src/mbpt.hpp src/ci.hpp src/tdhf.hpp src/itgl_transform.hpp src/cphf.hpp
